...
# Constants locally defined (previously from mediafiles)
IMAGE_FIELD_TYPES = ('PHOTO', 'SIGN', 'QR', 'BARCODE')
IMAGE_FIELD_NAME_PATTERNS = [
    'PHOTO', 'PIC', 'PICTURE', 'IMAGE', 'SIGN', 'SIGNATURE', 'QR', 'BARCODE', 'QRCODE'
]
...
def get_column_width_class(field):
    ...
    class Spec:
        html_th_class = 'min-w-[100px]'
        html_td_class = 'min-w-[100px] whitespace-normal break-words'
        align = 'center'
    spec = Spec()
